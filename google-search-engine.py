...
g.place(x=630, y=50)
g.bind("<Button-1>", lambda e: callback("https://webmail.au.syrahost.com/"))
...
signin.bind("<Button-1>", lambda e: callback("https://myaccount.google.com/?utm_source=OGB&utm_medium=app&pli=1"))
...
text.bind("<Button-1>", lambda e: callback("https://www.google.com/?gws_rd=ssl"))
...
search.bind("<Button-1>", lambda e: callback("https://www.google.com/?gws_rd=ssl"))
